...
inner join
	departments_dup
on
	dept_manager_dup.dept_no = departments_dup.dept_no
order by
...
-- Using Aggregate Functions with Joins
select * from employees e;
select * from salaries s order by s.emp_no;
